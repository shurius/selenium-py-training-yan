...
class Untitled3(unittest.TestCase):
    ...
    def test_untitled3(self):
        ...
        driver.find_element_by_name("name").send_keys("add_movie")
        ...
        driver.find_elements_by_xpath("//*[contains(text(), 'add_movie')]")
        driver.find_element_by_css_selector("h1").click()
        driver.find_element_by_id("q").clear()
        driver.find_element_by_id("q").send_keys("new_movie")
        ...
        self.assertFalse(self.is_element_present(By.LINK_TEXT, "add_movie"))
