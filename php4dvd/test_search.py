...
class Untitled6(unittest.TestCase):
    ...
    def test_untitled6(self):
        ...
        driver.find_element_by_name("name").send_keys("new1")
        ...
        driver.find_element_by_id("q").send_keys("new1")
        driver.find_element_by_id("q").click()
        driver.find_element_by_css_selector(".movie_box .nocover[alt=\"new1\"]")
