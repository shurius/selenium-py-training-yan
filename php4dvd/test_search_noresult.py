...
class Untitled7(unittest.TestCase):
    def setUp(self):
    ...
    def test_untitled7(self):
        ...
        driver.find_element_by_name("name").send_keys("movie_2_delete")
        driver.find_element_by_name("year").click()
        driver.find_element_by_name("year").clear()
        driver.find_element_by_name("year").send_keys("1999")
        driver.find_element_by_id("submit").click()
        driver.find_elements_by_xpath("//*[contains(text(), 'movie_2_delete')]")
        ...
        self.assertFalse(self.is_element_present(By.LINK_TEXT, "movie_2_delete"))
        driver.find_element_by_css_selector("h1").click()
        driver.find_element_by_id("q").clear()
        driver.find_element_by_id("q").send_keys("movie_2_delete")
        driver.find_element_by_id("q").click()
        driver.find_element_by_id("q").send_keys(Keys.RETURN)  
        driver.find_elements_by_xpath("//*[contains(text(), 'No movies where found.')]")
